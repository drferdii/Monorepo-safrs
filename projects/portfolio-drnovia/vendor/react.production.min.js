  ...
  ((c, x) => {
    ...
    function Z(a, b, e) {
      ...
      if (null != b)
        ...
        b))
          aa.call(b, m) && !Object.hasOwn(ba, m) && (d[m] = b[m]);
    ...
    function E(a) {
      ...
      if (e !== b) {
        a[0] = e;
        for (var c = 0, d = a.length, k = d >>> 1; c < k; ) {
          var h = 2 * (c + 1) - 1,
            l = a[h],
            f = h + 1,
            g = a[f];
    ...
    c.forwardRef = (a) => ({ $$typeof: wa, render: a });
    c.isValidElement = M;
    c.lazy = (a) => ({
      $$typeof: za,
    ...
    c.useSyncExternalStore = (a, b, c) =>
      g.current.useSyncExternalStore(a, b, c);
