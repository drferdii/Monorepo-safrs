(function () {
  ...
  const f = (e) => Math.min(1, 1.001 - 2 ** (-10 * e));
  var p = class {
    _isScrolling = !1;
    _isStopped = !1;
    _isLocked = !1;
    ...
    isTouchOnSelectionHandle(e) {
      ...
      const n = e.targetTouches[0] ?? e.changedTouches[0];
      if (!n) return !1;
