...
Last updated: 2026-08-21 (Portfolio unified to portfolio-drnovia; Sentra Bot runtime verified)

## Current state

- **Task:** `TASK-20260821-PORTFOLIO-LATE-SCAFFOLD` — `VERIFYING` — R2 — scope `projects/portfolio-drnovia/`.
...
- **Portfolio migration:** Unified into `projects/portfolio-drnovia/` (single clean capsule with docs, tests, and runnable React 18 site). `projects/portfolio/` keeps legacy pointer files.
- **Portfolio tests:** 26/26 tests PASS (`capsule-paths` + `lenis-contract`). SAFRS topology: OK.
