...
| `2026-08-21-smartboard-web-roadmap.md` | ACTIVE — index sub-fase `apps/web`, bukan plan eksekusi | Chief |
| `2026-08-21-smartboard-web-subphase1-foundation.md` | DRAFT — menunggu Chief approve (status ACTIVE) | Chief |
